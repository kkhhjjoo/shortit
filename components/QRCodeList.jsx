    ...
    <Card className={styles.qrcodeItem}>
      ...
      <div className={styles.qrCodeItemContent}>
        ...
        <div className={styles.link}>
          ...
          <Link variant="primary" href={value.url} target="_blank">{value.url}</Link>
        </div>
      </div>
      <div className={styles.buttons}>
        <Button variant="outline" as={Link} href={`/qrcodes/${id}`}>수정</Button>
        <Button variant="minimal" onClick={handleDelete}>삭제</Button>
      </div>
    </Card>
  );
}
