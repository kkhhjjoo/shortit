...
export default function ShortLinkForm({
  ...
  return (
    <Card>
      <form action="" className={styles.shortLinkForm} onSubmit={handleSubmit}>
        <label htmlFor="title" className={styles.label}>제목
          <Input className={styles.input} id="title" name="title" value={values.title} onChange={handleChange} placeholder="제목을 입력해주세요." />
        </label>  
        <label htmlFor="url" className={styles.label}>주소
